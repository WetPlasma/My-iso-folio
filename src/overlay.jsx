      ...
      >
        <style>
          {`
            ...
            ::-webkit-scrollbar-track { background: transparent; margin: 20px 0; }
            ::-webkit-scrollbar-thumb { background: #dcd0e5; border-radius: 20px; }
            ::-webkit-scrollbar-thumb:hover { background: #6a5a7a; }
            ::-webkit-scrollbar-button { display: none; }
          `}
        </style>

        {/* --- MAIN TITLE (Supercell Font) --- */}
        <div
          style={{
            position: "absolute",
            top: "40px",
          ...
          {isOpen && (
            <div
              style={{
                ...
                position: "relative",
                overflow: "hidden",
                // Apply Quicksand globally to the modal content
                  ...
                  >
                    ...
                    <div style={{ flex: 1 }}>
                      ...
                      >
                        ...
                        <p style={{ marginBottom: "15px" }}>
                          I am a developer passionate about creating immersive
                          web experiences using React Three Fiber and Blender.
                        </p>
                        <p>
                        ...
                        <p>
                          When I'm not coding or modeling low-poly worlds, you
                          can find me gaming or exploring new tech stacks.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                {page === "projects" && (
                  ...
                  >
                    ...
                    <section>
                      ...
                      >
                        A 3D interactive island built with three.js library
                        react Three Fiber, including low-poly models created
                        with blender.
                      </p>
                      <div style={{ width: "100%", height: "200px" }}>
                        <ProjectCard
                          ...
                          title=""
                          height="100%"
                          onClick={() => setFullscreenImg("/project1.jpg")}
                        />
                      </div>
                    </section>
                    ...
                    <section>
                      ...
                      >
                        Here are my 3D renders made with modeling. Check out
                      ...
                      >
                        <ProjectCard
                          image="/render1.png"
                          onClick={() => setFullscreenImg("/render1.png")}
                        />
                        <ProjectCard
                          image="/render2.jpg"
                          onClick={() => setFullscreenImg("/render2.jpg")}
                        />
                        <ProjectCard
                          image="/render3.jpg"
                          onClick={() => setFullscreenImg("/render3.jpg")}
                        />
                        <ProjectCard
                          image="/render4.jpg"
                          onClick={() => setFullscreenImg("/render4.jpg")}
                        />
                        <ProjectCard
                          image="/render5.jpg"
                          onClick={() => setFullscreenImg("/render5.jpg")}
                        />
                        <ProjectCard
                          image="/render6.jpg"
                          onClick={() => setFullscreenImg("/render6.jpg")}
                        />
                      </div>
                    </section>
                  </div>
